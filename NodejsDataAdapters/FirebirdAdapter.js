  ...
  try {
    ...
    var onConnect = function () {
      if (command.queryString) {
        var queryString = applyQueryParameters(
          command.queryString,
          command.parameters,
        ...
        for (var columnName in recordset[recordIndex]) {
          ...
          if (
            ...
            recordset[recordIndex][columnName] =
              recordset[recordIndex][columnName].toString();
          ...
          if (
            ...
            var dateTime = new Date(
              recordset[recordIndex][columnName].getTime() -
                recordset[recordIndex][columnName].getTimezoneOffset() * 60000
            ).toISOString();
